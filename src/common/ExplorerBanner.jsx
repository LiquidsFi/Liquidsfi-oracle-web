...
function ExplorerBanner() {
	return (
		...
		// </div>
		<Banner
			image={<img src="/Frame.svg" alt="" />}
			title="LiquidsFi Oracle Explorer"
			subtitle="Check out the most recent cross-chain message activity and browse the list of supported chains in this section"
		/>
	);
}
